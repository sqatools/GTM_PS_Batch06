...
square = num1**2
cube = num1**3
print("square and cube value accordingly is:" , square, cube)
...
#19). Python program to check whether the given number is an Armstrong number or not.  # uses if else statements.
